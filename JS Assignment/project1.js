...
async function fetchWeatherData() {
  try {
    const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=84dbdbfeb8debd274ee06fbac1dc4124`);//calling the api key link of own apiKey
    if (response.ok) {
